...
You can also use the ksql-datagen tool (part of KSQL project) to generate test data. You just need to provide an Avro file. Here is the file to create a continuous random test data sensor feed: https://github.com/kaiwaehner/confluent-live-demo-scripts-and-docs/blob/master/anomaly-detection-autoencoder/EcdSensorData.avro
